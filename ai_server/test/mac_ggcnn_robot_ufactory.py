...
# --- BİZİM ÇALIŞAN KİNEMATİĞİMİZ VE OFSETLER ---
CAMERA_OFFSET_X = 0.0  
CAMERA_OFFSET_Y = 50.0 
GRIPPER_Z_MM = 150.0                 
GRASPING_MIN_Z = 175.0               

# ==============================================================================
# 🎯 DÖNÜŞ (YAW) KALİBRASYONU
# Robotun elinin, kameranın açısına göre ne kadar sapması gerektiğini buradan ayarla.
# Eğer robot nesneye 90 derece ters/dik iniyorsa burayı 90.0 veya -90.0 yap.
# ==============================================================================
GRIPPER_ANGLE_OFFSET = 0.0  # Derece cinsinden (Örn: 90.0, -90.0, 180.0)
...
def get_grasp_data(depth_image_bytes, accurate_depth_mm):
    ...
    if DEBUG_MODE:
        ...
        debug_img[rr, cc, 0] = 0; debug_img[rr, cc, 1] = 255; debug_img[rr, cc, 2] = 0
...
def main():
    ...
    print("==================================================")
    print("🚀 MAC M1 - GGCNN (2-CLICK + YAW CALIBRATION)")
    print("==================================================")
            ...
            try:
                ...
                if resp.status_code == 200:
                    ...
                    if robot_state == "WAIT_TO_PICK":
                        ...
                        # AI AÇIYI BULUR
                        raw_ai_yaw, debug_img = get_grasp_data(depth_bytes, depth_mm)
                        
                        if debug_img is not None: last_debug_img = debug_img

                        if raw_ai_yaw is None:
                        ...
                        # AÇI KALİBRASYONUNU BURADA UYGULUYORUZ
                        target_yaw = raw_ai_yaw + GRIPPER_ANGLE_OFFSET

                        print(f"[ACTION] PICK: Object={target_name.upper()}, X={target_x:.1f}, Y={target_y:.1f}, Z={target_z:.1f}")
                        print(f"         └─> AI Angle: {raw_ai_yaw:.1f} | Robot Command Yaw: {target_yaw:.1f}")
